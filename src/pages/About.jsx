  ...
  return (
    <div className="relative w-full h-full mt-5 md:mt-12 p-1 z-10">
      <div className="flex flex-col items-center justify-center w-full">
        <div className="about-hero border px-4 py-1 md:py-1.5 md:px-4 rounded-full bg-[rgb(21,23,32)]">
          Code Beyond Limits
        </div>

        <div className="about-hero mt-5 text-center text-[7vw] md:text-[4vw] font-bold md:leading-20 md:max-w-[70vw] lg:max-w-[60vw]">
          Developing technology that moves ideas forward.
        </div>

        <p className="about-hero md:text-3xl mt-2 md:mt-8 max-w-[90vw] text-center md:max-w-[70vw] font-normal md:text[25px]">
        ...
        <div className="about-hero mt-10 md:mt-20 font-bold text-lg md:text-4xl">
      ...
      <div className="w-full flex items-center justify-center flex-col text-center md:text-xl mt-3">
        ...
        <div className="flex gap-2 md:gap-6 mt-4 md:mt-8">
          <div
            className="px-3 py-1 md:px-6 md:py-2 cursor-pointer border border-gray-700 rounded-xl"
