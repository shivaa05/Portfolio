...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed px-5 text-sm py-3 md:px-[10vw] md:py-5 md:text-lg font-semibold  md:font-bold flex justify-between items-center bg-black/60 backdrop-blur-sm">
