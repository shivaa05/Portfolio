...
const Footer = () => {
  return (
    <div className="absolute bottom-0 w-full px-2 md:px-[10vw] py-4 flex justify-center md:justify-between items-center">
      <div className="flex items-center gap-2">
        <Copyright className="size-5" /> 2026 Made by Shiva💖
      </div>

      <div className="hidden md:flex gap-2 md:gap-4 z-100 border px-15 py-3 rounded-full bg-[rgba(10,10,10,0.5)] backdrop-blur-5xl border-gray-600">
        <a
